...
import { ValidationPipeParam } from "../services.pipe";
...
export class NoteController implements OnModuleInit {
  ...
  @Get("category/:id")
  public async get_category(@Param("id",ValidationPipeParam) id: string) {
  ...
  @UseGuards(AuthGuard)
  @SetMetadata("role", [Role.Manager])
  public async update_category(@Param("id",ValidationPipeParam) id: string, @Body(ValidationPipe) dto: UpdateCatDto) {
  ...
  @Get(":id")
  async get(@Param("id",ValidationPipeParam) id: string) {
  ...
  @SetMetadata("role", [Role.Manager, Role.Author])
  @UseGuards(AuthGuard)
  async update(@Body(ValidationPipe) dto: UpdateNoteDto, @Param("id",ValidationPipeParam) id: string) {
